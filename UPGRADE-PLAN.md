...
- **S10.1** — 2026-08-17 → 2026-08-24 — Job queue (Arq/Celery on existing Redis); API returns job id; reuse SSE; idempotent jobs keyed on data hash. — 🚧 2026-08-17 → 2026-08-24 -- in progress (started 2026-05-17)
