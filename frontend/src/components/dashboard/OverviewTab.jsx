        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {Object.entries(category_charts).map(([column, chart_data]) => (
              <div key={column} className="glass-card p-5 chart-card">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {all_charts.map((chart, index) => (
              <div key={index} className="glass-card p-5 chart-card">
                <h4 className="text-sm font-medium text-slate-100 mb-3 truncate" title={chart.title || chart.id || 'Chart'}>
